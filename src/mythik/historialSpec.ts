 ...
 * direct CSS values"). Los colores vienen de la paleta activa (tema claro/oscuro).
 *
 ...
 */
export function buildHistorialSpec(c: Palette): Spec {
  return {
    root: 'screen',
    ...
    elements: {
      ...
      cargando: {
        ...
        style: { color: c.textMuted, fontSize: 14, paddingVertical: 12 },
        visible: {
          $and: [
            { $state: '/ui/loading' },
      ...
      'fila-kcal': {
        ...
        style: { color: c.accent, fontSize: 15, fontWeight: '700' },
      },
      ...
      vacio: {
        ...
        style: { color: c.textMuted, fontSize: 14, paddingVertical: 24 },
        visible: {
          $and: [
